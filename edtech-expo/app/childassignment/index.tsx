...
import { fetchAssignmentsByClass, fetchChildAssignmentsByClass } from '../services/Class.service';
...
const Assignment = () => {
  ...
  const { courseUuid, childId } = useLocalSearchParams<{ courseUuid: string; childId: string }>();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetchChildAssignmentsByClass(courseUuid, childId);
